import { Widget, Network, Utils, Variable } from '../../../imports'

const { execAsync } = Utils

const ControlPanelTab = Variable("main", {})
const APInfoVisible = Variable(false, {})

// Holds current wifi access point selected
const CurrentAP = Variable({}, {})

// Holds current bluetooth device selected
const CurrentDevice = Variable({}, {})
...
// --- may need to be moved to sysinfo.ts
